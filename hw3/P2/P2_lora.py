...
class Decoder(nn.Module):
    def __init__(self, cfg):
        ...
        self.transformer = nn.ModuleDict(
            dict(
                wte=lora.Embedding(cfg.vocab_size, cfg.n_embd, r=16),  # (50257,768)
                wpe=lora.Embedding(cfg.block_size, cfg.n_embd, r=16),  # (1024,768)
...
def main():
    ...
    for epoch in range(EPOCHS):
        ...
        torch.save(save_weights, f"model_lora_r16_{epoch}.pt")

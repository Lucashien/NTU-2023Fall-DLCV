...
class Task:
    def __init__(self, config, annots, args):
        super().__init__()
        self.config = config
        self.annots = annots
        ...
        #self.clip_dir = '/home/remote/mplin/DLCV/VQLoC/new_data/data/clips/'
    ...
    def run(self, config, device):
        ...
        for key, annot in zip(self.keys, self.annots):
            ...
            peaks, largest_score = process_peaks(peaks, ret_scores_sm)
...
def process_peaks(peaks_idx, ret_scores_sm):
    ...
    return valid_peaks_idx, largest_score

...
def perform_vq2d_inference(annotations, config, args):
    ...
    workers = [
        ...
        #WorkerWithDevice(config, task_queue, results_queue, i, i % num_gpus+1)
...
if __name__ == '__main__':
    ...
    perform_vq2d_inference(clipwise_annotations_list, config, args)
